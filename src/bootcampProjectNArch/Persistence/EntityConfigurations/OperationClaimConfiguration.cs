...
#pragma warning disable S1854 // Unused assignments should be removed
    private IEnumerable<OperationClaim> getFeatureOperationClaims(int initialId)
    {
        ...
        #region ApplicationEs
        featureOperationClaims.AddRange(
            [
                new() { Id = ++lastId, Name = ApplicationEsOperationClaims.Admin },
                new() { Id = ++lastId, Name = ApplicationEsOperationClaims.Read },
                new() { Id = ++lastId, Name = ApplicationEsOperationClaims.Write },
                new() { Id = ++lastId, Name = ApplicationEsOperationClaims.Create },
                new() { Id = ++lastId, Name = ApplicationEsOperationClaims.Update },
                new() { Id = ++lastId, Name = ApplicationEsOperationClaims.Delete },
            ]
        );
        #endregion
